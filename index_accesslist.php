...
-->
				...
				<tr data-ng-repeat="name in namesData">
				    <td><medium style="color:#4B0082">{{name.account}}</medium></td>
				    <td>{{name.fullname}}</td>
...
-->
				    ...
				    <td><button type="button" ng-click="fetchSingleAccess(name.id,name.fullname)" class="btn btn-info btn-xs">Routes</button></td>
                    <td><button type="button" ng-click="fetchSingleAccess(name.id,name.fullname)" class="btn btn-primary btn-xs">AccessList</button></td>
    ...
    <div class="modal-dialog" role="document" style="width: 90% ">
        <div class="modal-content">
            <form method="post" ng-submit="insertAclData()">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">{{modalTitle}} {{modalUser}}</h4>
                </div>
                    ...
                    <form name="testform" ng-submit="insertData()">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td><button type="submit" class="btn btn-success " ng-disabled="testform.$invalid"> Add  IP  rule</button></td>
                            </tr>
...
app.controller('crudController', function($scope, $http) {
    ...
    //     $http.get('/accesslist/select.php').success(function(data){
    //         $scope.namesData = data;
    //     });
    // };
